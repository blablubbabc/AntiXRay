...
abstract class DataStore {
	...
	private void loadMessages() {
		...
		this.addDefault(defaults, Messages.CommandHelpHeader, "&2----- &4AntiXRay Commands &2-----", null);
		this.addDefault(defaults, Messages.CommandReloadCmd, "&e/antixray reload", null);
		this.addDefault(defaults, Messages.CommandReloadDesc, "&3     - Reloads the configuration and messages.", null);
		...
		this.addDefault(defaults, Messages.CommandCheckDesc, "&3     - Shows you your or another players current points.", null);
		...
		this.addDefault(defaults, Messages.CommandSetDesc, "&3     - Sets the players points or counter value.", null);
